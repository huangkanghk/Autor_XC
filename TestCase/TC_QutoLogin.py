...
class TestQutoLogin(unittest.TestCase):
    ...
    #                 sapno1 = bomrow[1]
    #                 quat = bomrow[3]
    #                 arr = TestQutoLogin.fact(sapno=sapno1,quat=quat,cur=cur)
    #                 datarow.append(arr)
    #         else:
    #             datarow.append(row)
    #
    ...
    def testQutoLogin_0032(self):
        ...
        for row in rows:
            ...
            for record in records:
                if record["category"] == "供应":
                    print(123)
            records = records[0]
            if records["quantity"] != row[1]:
                print(row)
